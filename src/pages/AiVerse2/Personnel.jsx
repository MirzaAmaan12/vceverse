...
function ProfileCard({ person }) {
  return (
    <motion.div whileTap={{ scale: 0.98 }} className="relative p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white/[0.02] border border-white/10 flex flex-col items-center text-center overflow-hidden">
