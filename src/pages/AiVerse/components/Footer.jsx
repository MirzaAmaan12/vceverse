...
export default function Footer() {
  return (
    <footer className="relative py-12 sm:py-16 px-4 border-t border-white/10 bg-[#020205]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h3 className="text-xl sm:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#00F2FE] to-cyan-300 mb-2">
            AI-VERSE
          </h3>
          <p className="text-white/40 text-xs sm:text-sm mb-6">
            The Beginning of AI Excellence
          </p>
